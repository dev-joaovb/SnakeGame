...
// yy: vertical
    ...
    /// coluna horizontal
    { xx: 450, yy: 270, color: 'white' },
    { xx: 450, yy: 300, color: 'white' },
    { xx: 450, yy: 330, color: 'white' },

    { xx: 420, yy: 270, color: 'white' },
    { xx: 420, yy: 300, color: 'white' },
    { xx: 420, yy: 330, color: 'white' },

    { xx: 390, yy: 270, color: 'white' },
    { xx: 390, yy: 300, color: 'white' },
    { xx: 390, yy: 330, color: 'white' },

    { xx: 360, yy: 270, color: 'white' },
    { xx: 360, yy: 300, color: 'white' },
    { xx: 360, yy: 330, color: 'white' },

    { xx: 330, yy: 270, color: 'white' },
    { xx: 330, yy: 300, color: 'white' },
    { xx: 330, yy: 330, color: 'white' },

    { xx: 300, yy: 270, color: 'white' },
    { xx: 300, yy: 300, color: 'white' },
    { xx: 300, yy: 330, color: 'white' },

    { xx: 270, yy: 270, color: 'white' },
    { xx: 270, yy: 300, color: 'white' },
    { xx: 270, yy: 330, color: 'white' },

    { xx: 240, yy: 270, color: 'white' },
    { xx: 240, yy: 300, color: 'white' },
    { xx: 240, yy: 330, color: 'white' },

    { xx: 210, yy: 270, color: 'white' },
    { xx: 210, yy: 300, color: 'white' },
    { xx: 210, yy: 330, color: 'white' },

    { xx: 180, yy: 270, color: 'white' },
    { xx: 180, yy: 300, color: 'white' },
    { xx: 180, yy: 330, color: 'white' },

    { xx: 150, yy: 270, color: 'white' },
    { xx: 150, yy: 300, color: 'white' },
    { xx: 150, yy: 330, color: 'white' },

    { xx: 120, yy: 270, color: 'white' },
    ...
    { xx: 270, yy: 390, color: 'white' },
    { xx: 300, yy: 390, color: 'white' },
    ...
    export function getAdditionalSquaresF7(){
        return additionalSquares7
    }
